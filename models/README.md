...
`models/experimental/` contains meta-learning surrogates (MAML, exact FSBO, and a warm-start GP transfer baseline) plus graph neural networks (MPNN, GPS-MPNN) that require additional dependencies.
