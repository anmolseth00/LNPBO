...
Working with the full [LNPDB](https://github.com/evancollins1/LNPDB) dataset requires cloning it as a sibling directory and creating the expected symlink:
...
- [Molecular Encodings](encodings.md) -- Understand the 9 encoding options and when to use each
