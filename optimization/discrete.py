...
def score_candidate_pool(
    ...
    if surrogate == "xgb":
        ...
        n_cv = max(2, min(5, len(X_train_s)))
        ...
        from ..models.sngp import train_sngp
        ...
        from ..models.laplace import build_laplace, train_mlp
        ...
        from ..models.groupdro import train_groupdro
        ...
        from ..models.vrex import train_vrex
