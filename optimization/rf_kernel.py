...
Davies, A. & Ghahramani, Z. (2014). "The Random Forest Kernel and other
    kernels for big data from random partitions." arXiv:1402.4293.
    (proves the RF proximity matrix is positive semi-definite)
"""
...
class RandomForestKernel(Kernel):
    ...
    - Positive semi-definite (it is an inner product in the binary
      leaf-indicator feature space; proof in Davies & Ghahramani 2014).
